...
<script>
    ...
    /*export let metadata = {
        end_session_endpoint: 'http://keycloak:9999/auth/realms/mytrack/protocol/openid-connect/logout',
        authorization_endpoint: 'http://keycloak:9999/auth/realms/mytrack/protocol/openid-connect/auth',
        token_endpoint: 'http://keycloak:9999/auth/realms/mytrack/protocol/openid-connect/token',
        issuer: 'http://keycloak:9999/auth/realms/mytrack',
        userinfo_endpoint: 'http://keycloak:9999/auth/realms/mytrack/protocol/openid-connect/userinfo'
    };*/
