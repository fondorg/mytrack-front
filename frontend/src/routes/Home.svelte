        ...
        <CenteredFlex extraClasses="mt-10">
            ...
            <div class="text-justify md:w-3/4 px-2 md:px-0">
                <div>
                    ...
                    The project currently contains of a couple of separate services. Source can be found here:
                </div>
                <ul class="list-disc">
                    <li>
                ...
                <div class="mt-2">
                    <MicroTitle title="Technology stack"/>
                ...
                <div class="mt-2">
                    <MicroTitle title="MyTracker features"/>
